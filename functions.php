...
function dro_pizza_scripts() {
	...
	wp_enqueue_script( 'dro-pizza-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20190825', true );

	wp_enqueue_script( 'dro-pizza-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20190825', true );
